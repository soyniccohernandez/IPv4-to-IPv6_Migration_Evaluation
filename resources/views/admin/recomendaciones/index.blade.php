        ...
        <script>
            ...
            function nuevaRecomendacion() {
                ...
                $('#modalEditar').on('hidden.bs.modal', function() {
                    ...
                    $('#formulario_agregar_actualizar_recomendacion')[0].reset();
                });
                ...
                btn_nueva_recomendacion.addEventListener('click', () => {
                    ...
                    $(formulario_agregar_actualizar_recomendacion).validate({
                        rules: {
                            inputRecomendacion: {
                                required: true,
                                minlength: 15
                        ...
                        messages: {
                            inputRecomendacion: {
                                ...
                                minlength: "La recomendación debe tener al menos 15 caracteres."
                            },
                            inputCategoria: {
            ...
            function eliminarRecomendacion() {
                // Delegación de eventos en el contenedor de las recomendaciones
                document.getElementById('table-recomendaciones').addEventListener('click', function(event) {
                    // Verificar si el clic ocurrió en un botón con la clase 'btn_eliminar_recomendacion'
                    if (event.target.classList.contains('btn_eliminar_recomendacion')) {
